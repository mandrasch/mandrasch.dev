<div class="w-full p-2 text-center mt-10 bg-slate-100">
	<p>
		Made with SvelteKit (<a
			class="underline"
			href="https://github.com/mandrasch/landingpage-matthiasandrasch/tree/sveltekit-conversion"
			>Source</a
		>) | Emojis by <a href="https://openmoji.org/" class="underline">openmoji.org</a> (CC BY ShareAlike
		4.0)
	</p>
	<p>
