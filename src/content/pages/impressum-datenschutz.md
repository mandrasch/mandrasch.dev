...
Dies ist mein privater Weblog. Dieses Impressum und die Datenschutzerklärung gilt zudem für folgende Web-Auftritte:

*   https://\*.matthias-andrasch.eu
...
*   für GitHub Pages gelten die [Privacy Terms von GitHub](https://docs.github.com/en/pages/getting-started-with-github-pages/about-github-pages#data-collection)
*   für Vercel gilt die [Privacy Policy von Vercel](https://vercel.com/legal/privacy-policy)
*   für Cloudflare Pages (pages.dev) gilt die [Privacy Policy von Cloudflare](https://www.cloudflare.com/de-de/privacypolicy/)

Die meisten Projekte hoste ich auf [https://www.manitu.de/](https://www.manitu.de/), siehe [Erfahrungsbericht](https://matthias-andrasch.eu/blog/2021/gruenes-eu-webhosting-fuer-bildungsprojekte-manitu/).

Bei meinem Blog, den dazugehörigen, oben aufgeführten Webseiten sowie dem OERhörnchen-Projekt handelt es sich um private, nichtkommerzielle, werbefreie Webauftritte und Freizeitprojekte, welche auch als Open Source der Allgemeinheit zur Verfügung stehen.

**Offenlegung gem. §25 Mediengesetz** **Österreich**

Matthias Andrasch  
1160 Wien  
Kontakt: matthias-andrasch-kontakt@mailbox.org

**Urheberrecht – Bloginhalte**

![](https://matthias-andrasch.eu/blog/wp-content/uploads/2019/01/cc-zero-badge.png)

Alle eigenen Beiträge (Text) sind freigegeben unter [CC0 (Creative Commons Zero)](https://creativecommons.org/publicdomain/zero/1.0/deed.de). Ausgenommen sind anders gekennzeichnete Inhalte und eingebundene Medieninhalte. Im Zweifel gerne einfach kurz nachfragen. Mehr zur CC0-Freigabe: [Die Schönheit des offenen Teilens (Manifest)](https://www.youtube.com/watch?v=ZHcV27nwlw8).

### Datenschutz-Einstellungen

Für eingebettete Social Media Inhalte wird Borlabs Cookie eingesetzt. Borlabs setzt bei der Option „Alle Inhalte von Twitter / YouTube / etc.“ einen Präferenz-Cookie. Dieser enthält keinerlei personenbezogene Daten. Sie können diese Einstellung hier zurücksetzen:

\[borlabs-cookie type=“btn-cookie-preference“ title=“Cookie / Embed-Einstellungen“/\]
